...
def generar_pdf(rut: str, nombre: str, sesiones: list) -> str:
    ...
    if sesiones:
        ...
        datos_tabla = [[
            ...
            Paragraph("Equipo", cabecera_style),
            Paragraph("Trabajo Realizado", cabecera_style),
            Paragraph("Técnico", cabecera_style),
        ]]
        ...
        for s in sesiones:
            ...
            datos_tabla.append([
                ...
                Paragraph(f"{s.get('equipo', '')} ({s.get('referencia', '')})", celda_style),
                Paragraph(str(s.get("trabajo_realizado", "")), celda_style),
                Paragraph(str(s.get("tecnico", "")), celda_style),
            ])
