...
def limpiar_datos():
    print("Iniciando limpieza de base de datos de Hidropro Bombas...")
    ...
    print("\n¡Limpieza completada! El entorno está vacío y listo para nuevas pruebas.")
